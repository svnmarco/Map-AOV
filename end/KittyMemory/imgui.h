...
typedef int ImGuiTableColumnFlags;  // -> enum ImGuiTableColumnFlags_// F&lags: For TableSetupColumn()
...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsDarkMode(ImGuiStyle* dst = NULL);    // new, recommended style (default)
    // Windows
